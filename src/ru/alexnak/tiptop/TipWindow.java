...
import ru.alexnak.tiptop.settings.ApplicationSettingsComponent;
import ru.alexnak.tiptop.settings.Settings;
...
public class TipWindow extends JWindow {
    ...
    public TipWindow(Frame owner, String text, Component sourceComponent) {
        super(owner);
        ApplicationSettingsComponent component = ApplicationManager.getApplication().getComponent(ApplicationSettingsComponent.class);
        Settings mySettings = component.getState();
        setAlwaysOnTop(true);
    ...
    class TipLabel extends JLabel {
        ...
        public TipLabel(String text, Settings mySettings) {
            super();
