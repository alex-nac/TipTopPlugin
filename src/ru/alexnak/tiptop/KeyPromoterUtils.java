...
public class KeyPromoterUtils {
    ...
    public static String renderMessage(String description, String shortcutText, Integer count) {
        ApplicationSettingsComponent keyPromoterConfiguration = ApplicationManager.getApplication().getComponent(ApplicationSettingsComponent.class);
        Settings settings = keyPromoterConfiguration.getState();
